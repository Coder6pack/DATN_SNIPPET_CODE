          ...
          <div className='mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16'>
            ...
            <div className='col-span-2 lg:col-span-3 lg:flex lg:items-end '>
              <form className='w-full'>
                ...
                <div className='border-none p-2 focus:border-none sm:flex sm:items-center sm:gap-4'>
                  <Input
                    type='email'
                    id='UserEmail'
                    placeholder='john@rhcp.com'
                    className='w-full border-tagColor outline-none sm:text-sm'
                  />

                  <Button className=' bg-teal-500 '>Sign Up</Button>
                </div>
              </form>
            </div>
